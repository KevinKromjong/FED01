site.views.Weather = Backbone.View.extend({
    ...
    getChosenWeather : function(e){
        ...
        weatherClicked = e.currentTarget.innerHTML;     //Neem de waarde die in de link staat waar op geklikt is

        if(weatherClicked == "Droog"){                  //Als deze waarde "Droog" is..
            this.weatherAdvantage = 0.9;                //Dan is het voordeel 0.9
        }

        if(weatherClicked == "Regen"){                  //Als deze waarde "Nat" is..
            this.weatherAdvantage = 1.2;                //Dan is het nadeel 1.2
        }

        site.events.trigger('weatherChosen', {weather : this.weatherAdvantage});    //Trigger vervolgens het event weatherChosen waarbij dit voordeel of nadeel wordt meegegeven
    }
